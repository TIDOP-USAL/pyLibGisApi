...
PROJECT_TAG_DATA_MODEL_ID = 'datamodel_id'
PROJECT_TYPE_DEFAULT = 'default'
PROJECT_DATE_TIME_FORMAT ='yyyy-MM-dd HH:mm:ss'
PROJECT_TAG_ID = 'id'
PROJECT_TAG_ID_WITH_PROJECT = 'project_id'
...
LAYER_LAYERS_GROUPS_TAG_NAME = 'name'
LAYER_LAYERS_GROUPS_TAG_ID = 'group_id'
LAYER_LAYERS_GROUPS_TAG_LAYERS = 'layers'
